...
class ServerControlServiceStub(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def __init__(self, channel):
        ...
        self.TerminateServer = channel.unary_unary(
                '/hipstershop.ServerControlService/TerminateServer',
                request_serializer=demo__pb2.ControlRequest.SerializeToString,
                response_deserializer=demo__pb2.Empty.FromString,
                )


class ServerControlServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ServerControlServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TerminateServer': grpc.unary_unary_rpc_method_handler(
                    servicer.TerminateServer,
                    request_deserializer=demo__pb2.ControlRequest.FromString,
                    response_serializer=demo__pb2.Empty.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'hipstershop.ServerControlService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class ServerControlService(object):
    ...
    def TerminateServer(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hipstershop.ServerControlService/TerminateServer',
            demo__pb2.ControlRequest.SerializeToString,
            demo__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
